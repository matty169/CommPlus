namespace :db do
  ...
  task populate: :environment do
    ...
    ruby_atendees = Attendee.create!(event_id: hack.id, user_id: matthew.id)
    hackathon_atendees = Attendee.create!(event_id: ruby.id, user_id: matthew.id)
    ...
    #list = Attendee.create!(user_id: matthew.id, skill_id: parkour.id)
    #list = Attendee.create!(user_id: matthew.id)
