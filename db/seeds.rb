...
# Create matthew
    ...
    hack = Event.create!(host_id: 1, name: "Hackathon", location: "Wits, D-lab", description: "This is going to be a long weeked", photo_url: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSQR71HEKbVeGmfi-Ddy9LJFdXSFkaMjEgE8GIFor_3net_7s9SyQ")
    ruby = Event.create!(host_id: 1, name: "Ruby Lesson", location: "Wits, D-lab", description: "This is going to be a long weeked", photo_url: " http://www.firstlinesoftware.com/wp-content/uploads/2013/03/ruby-vs-php.jpg")
    parkoursaterday = Event.create!(host_id: 1, name: "Parkour Intro", location: "Wits Red Brick", description: "This is going to be a long weeked", photo_url: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQRvrhE_fJWTZfEBwEzlRt96DlFCs3285jKJpgGBioposGJ5SF0")
    bakeaway = Event.create!(host_id: 1, name: "Macaroon Baking", location: "Robs House", description: "This is going to be a long weeked", photo_url: "http://distilleryimage0.ak.instagram.com/9e4850a2d5d011e2939b22000a1f9251_7.jpg")
    codencofee = Event.create!(host_id: 1, name: "Code n Coffee", location: "Mug n Bean", description: "This is going to be a long weeked", photo_url: "http://www-andrewspittle-net.zippykid.netdna-cdn.com/wp-content/uploads/2013/02/coffee-and-code-1200x803.jpg")
    tennis = Event.create!(host_id: 1, name: "Tennis Lessons", location: "Wits Tennis Courts", description: "This is going to be a long weeked", photo_url: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcR-SiaYEftSy9JeGhb7TUO0fag5XMFxx80-CACg5K4sNJXidfKvSg")
    yoga = Event.create!(host_id: 1, name: "Fun in the Sun Yoga", location: "Wits", description: "This is going to be a long weeked", photo_url: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQPKEhp1rdR0ZkUXOpO8doIXoXiMOrDkFTWQTyjz6M4Iy0q1Gtseg")
    demoday = Event.create!(host_id: 1, name: "MIT Demo Day", location: "Wits, Alumni House", description: "This is going to be a long weeked", photo_url: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTRst7sKKANLkoXQrp9Xoeej7u9sSe_iY8NuC-Pd8a4CUGK8Rql")
